...
mod tests {
    ...
    fn is_theoretically_possible_one_bad_constraint_false() {
        ...
        let constraint2 = Constraint {
            id: 2,
            valid_values: vec![].into_iter().collect(),
        };
        let constraint3_123 = Constraint {
            id: 3,
            valid_values: vec![1, 2, 3].into_iter().collect(),
    ...
    fn combine_no_id_common() {
        ...
        let constraint4_123 = Constraint {
            id: 4,
            valid_values: vec![1, 2, 3].into_iter().collect(),
        };
    ...
    fn combine_one_id_common() {
        ...
        let constraint2_345 = Constraint {
            id: 2,
            valid_values: vec![3, 4, 5].into_iter().collect(),
        };
        let constraint3_123 = Constraint {
            id: 3,
            valid_values: vec![1, 2, 3].into_iter().collect(),
    ...
    fn combine_all_id_common() {
        ...
        let constraint1_234 = Constraint {
            id: 1,
    ...
    fn test_clone_from() {
        ...
        let mut constraint_two = Constraint {
            id: 3,
            valid_values: vec![4, 5, 6].into_iter().collect(),
        };
