...
mod tests {
    ...
    fn test_new_empty_constraint_map() {
        ...
        assert_eq!(constraint_map, ConstraintMapFactory::new_empty_constraint_map());        
    }
    ...
    fn test_new_constraint_map() {
        ...
        let constraint_map = ConstraintMap { map };
        assert_eq!(constraint_map, ConstraintMapFactory::single_constraint_constraint_map(constraint3_123));        
    }
    ...
    fn test_new_constraint_map_no_constraint() {
        ...
        let map: HashMap<u16, Constraint> = HashMap::new();
        let constraint_map = ConstraintMap { map };
        assert_eq!(constraint_map, ConstraintMapFactory::new_constraint_map(constraint_iter));        
    }
    ...
    fn test_new_constraint_map_constraints() {
        ...
        let constraint3_123 = Constraint {id: 3, valid_values: vec![1, 2, 3].into_iter().collect()};
        let constraint_iter = vec![constraint1_123.clone(), constraint2_123.clone(), constraint3_123.clone()].into_iter();
    ...
    fn test_new_constraint_map_constraints_some_overlap() {
        let constraint1_123 = Constraint {id: 1, valid_values: vec![1, 2, 3].into_iter().collect()};
        let constraint2_123 = Constraint {id: 2, valid_values: vec![1, 2, 3].into_iter().collect()};
        let constraint2_23 = Constraint {id: 2, valid_values: vec![2, 3].into_iter().collect()};
        let constraint2_234 = Constraint {id: 2, valid_values: vec![2, 3, 4].into_iter().collect()};
        let constraint3_123 = Constraint {id: 3, valid_values: vec![1, 2, 3].into_iter().collect()};
        let constraint_iter = vec![constraint1_123.clone(), constraint2_123, constraint2_234, constraint3_123.clone()].into_iter();
