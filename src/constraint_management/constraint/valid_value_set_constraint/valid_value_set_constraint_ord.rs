    ...
    T: Ord + PartialOrd + Hash + Debug,
{
    ...
    /// # Arguments
    ///
    /// * `self` - The first [ValidValueSetConstraint] to compare.
    /// * `other` - The second [ValidValueSetConstraint] to compare.
    ///
    /// # Returns
    ///
    /// An [Ordering] value indicating the relationship between the [ValidValueSetConstraint]s.
    ///
    /// # Examples
    /// ```
    /// # use crate::rusted_dice::constraint_management::ValidValueSetConstraint;
    /// let constraint_set_one = ValidValueSetConstraint::new_many_item_constraint(1, vec![1, 2, 5]);
    /// let constraint_set_two = ValidValueSetConstraint::new_many_item_constraint(4, vec![2, 5]);
    /// assert!(constraint_set_one < constraint_set_two);
    /// assert!(constraint_set_one.lt(&constraint_set_two));
    /// ```
    ...
    T: Ord + PartialOrd + Hash + Debug,
{
    ...
    /// # Returns
    ///
    /// An `Option<Ordering>` value indicating the relationship between the [ValidValueSetConstraint]s,
    ...
    /// let constraint_two = ValidValueSetConstraint::new_many_item_constraint(4, vec![2, 5]);
...
mod tests {
    ...
    #[test]
    fn test_cmp_less() {
        let constraint_one = ValidValueSetConstraint::new_many_item_constraint(1, vec![2, 4]);
    ...
    fn test_cmp_less_valid_values() {
        let constraint_one = ValidValueSetConstraint::new_many_item_constraint(2, vec![2, 4, 5]);
        let constraint_two = ValidValueSetConstraint::new_many_item_constraint(2, vec![2, 4, 6]);
        assert_eq!(constraint_one.cmp(&constraint_two), Less);
        assert_eq!(constraint_one.partial_cmp(&constraint_two), Some(Less));
    }
    ...
    fn test_cmp_less_valid_values_uneven_length() {
        let constraint_one = ValidValueSetConstraint::new_many_item_constraint(2, vec![2, 4]);
        let constraint_two = ValidValueSetConstraint::new_many_item_constraint(2, vec![2, 4, 6]);
        assert_eq!(constraint_one.cmp(&constraint_two), Less);
        assert_eq!(constraint_one.partial_cmp(&constraint_two), Some(Less));
    }
    ...
    fn test_cmp_less_valid_values_uneven_length_different_values() {
        ...
        let constraint_two = ValidValueSetConstraint::new_many_item_constraint(2, vec![2, 7]);
        assert_eq!(constraint_one.cmp(&constraint_two), Less);
        assert_eq!(constraint_one.partial_cmp(&constraint_two), Some(Less));
    }
    ...
    #[test]
    fn test_cmp_greater() {
        let constraint_one = ValidValueSetConstraint::new_many_item_constraint(3, vec![2, 4, 6, 7]);
        let constraint_two = ValidValueSetConstraint::new_many_item_constraint(2, vec![2, 4, 6, 8]);
    ...
    fn test_cmp_greater_valid_values() {
        let constraint_one = ValidValueSetConstraint::new_many_item_constraint(3, vec![2, 4, 7, 8]);
        let constraint_two = ValidValueSetConstraint::new_many_item_constraint(3, vec![2, 4, 6, 8]);
        assert_eq!(constraint_one.cmp(&constraint_two), Greater);
        assert_eq!(constraint_one.partial_cmp(&constraint_two), Some(Greater));
    }
    ...
    fn test_cmp_greater_valid_values_uneven_length() {
        let constraint_one = ValidValueSetConstraint::new_many_item_constraint(3, vec![2, 4, 6]);
        let constraint_two = ValidValueSetConstraint::new_many_item_constraint(3, vec![2, 4]);
        assert_eq!(constraint_one.cmp(&constraint_two), Greater);
        assert_eq!(constraint_one.partial_cmp(&constraint_two), Some(Greater));
    }
    ...
    fn test_cmp_greater_valid_values_uneven_length_different_values() {
        let constraint_one = ValidValueSetConstraint::new_many_item_constraint(3, vec![2, 4, 6]);
        let constraint_two = ValidValueSetConstraint::new_many_item_constraint(3, vec![2, 3]);
        assert_eq!(constraint_one.cmp(&constraint_two), Greater);
        assert_eq!(constraint_one.partial_cmp(&constraint_two), Some(Greater));
    }
    ...
    fn test_cmp_equal() {
        let constraint_one =
            ValidValueSetConstraint::new_many_item_constraint(321, vec![-3, 2, 4, 6, 89]);
        let constraint_two =
            ValidValueSetConstraint::new_many_item_constraint(321, vec![-3, 2, 4, 6, 89]);
